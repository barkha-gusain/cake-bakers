    ...
    <>
      ...
      <section className="home-section">
        <div className="home-content">
          ...
          <p>
            Discover the magic of freshly backed goodness. Handcrafted with love
            and the finest ingerdients.Delight in every bite, every day.
          </p>
      ...
      <section className="content-section">
        <div className="text-content">
          ...
          <p>
            Experience the warmth of homemade taste. Our cookies are baked fresh
            every morning using premium ingredients and love.
          </p>
          <a href="#cookies" className="read-more-link">
            Read More
          </a>
        </div>
        ...
        <div className="text-content">
          ...
          <p>
            Dive into the world of luxurious flavors and artfully crafted
            designs. Our cakes are baked with passion and premium ingredients to
            make every bite memorable.
          </p>
          <a href="/cakes" className="read-more-link">
            Read More
          </a>
        </div>
      </div>
        ...
        <div className="newsletter-box">
          <div className="newsletter-content">
            <div className="newsletter-text">
              ...
              <p>
                Delight in the magic of the season with our Christmas Craving{" "}
                <br />
      ...
      <footer className="footer-main">
        ...
        <div className="footer-2">
          <div className="footer-grid-1">
            ...
            <p>
              Whipping up delightful treats daily. SweetBakes brings freshness,
              flavor, and love to your plate.
            </p>
          </div>
          ...
          <div className="footer-grid-4">
            ...
            <p>Subscribe to get updates and sweet offers!</p>
